...
import type { JSONSchema4, JSONSchema6, JSONSchema7 } from "npm:json-schema";
...
export type SchemaObjectWithRef =
  & Omit<
    JSONSchema,
    | "type"
    | "allOf"
  ...
  & {
    // OpenAPI specific overrides
    type?: "string" | "number" | "integer" | "boolean" | "object" | "array";
    allOf?: (SchemaObjectWithRef | ReferenceObject)[];
    oneOf?: (SchemaObjectWithRef | ReferenceObject)[];
    anyOf?: (SchemaObjectWithRef | ReferenceObject)[];
    not?: SchemaObjectWithRef | ReferenceObject;
    items?: SchemaObjectWithRef | ReferenceObject;
    properties?: Map<SchemaObjectWithRef | ReferenceObject>;
    additionalProperties?: boolean | SchemaObjectWithRef | ReferenceObject;
